...
malvin({
  pattern: 'nova',
  alias: ['ds', 'deepseek'],
  desc: 'Ask Nova Xmd AI a question',
  category: 'ai',
  react: '🤖',
  filename: __filename
  ...
  if (isGreeting(query)) {
    await malvin.sendMessage(
      from,
      {
        text: "*Hello! How may Nova AI help you today?*",
        contextInfo: {
          mentionedJid: [m.sender],
          forwardingScore: 999,
          isForwarded: true
  ...
  if (qLower.includes("who made you") || qLower.includes("who created you") || qLower.includes("who is your owner") || 
      ...
      qLower.includes("who is nova xmd")) {
    await malvin.sendMessage(
      from,
      {
        text: `*About Me:*\n\n*I'm nova AI, created by Bmb Tech, a 21-year-old full stack developer from Tanzania. I'm part of a family that includes Nova xmd and Bugatti bots, all available on GitHub.*\n\n> How may I assist you today?`,
        contextInfo: {
          mentionedJid: [m.sender],
          forwardingScore: 999,
          isForwarded: true,
  ...
  if (qLower.includes("language model") || qLower.includes("llm") || qLower.includes("what model")) {
    await malvin.sendMessage(
      from,
      {
        text: `*Only Nova Xmd knows my specific language models, but I was created to help you in your day-to-day activities.*\n\n*What would you like to discuss today?*`,
        contextInfo: {
          mentionedJid: [m.sender],
          forwardingScore: 999,
          isForwarded: true
  ...
  const personality = `
    You are Nova Xmd AI - an intelligent assistant that provides helpful, detailed responses.
  ...
  try {
    ...
    await malvin.sendMessage(
      from,
      {
        text: `*Nova Xmd AI (via ${apiUsed}):*\n\n${response}\n\n> Powered by Nova Xmd Technologies`,
        contextInfo: {
          mentionedJid: [m.sender],
          forwardingScore: 999,
          isForwarded: true,
