    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await malvin.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "Vision V",
            body: config.DESCRIPTION || "nova xmd",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://github.com/novaxmd/BMB-XMD-DATA/raw/refs/heads/main/nova%20tech.jpg", // Static image URL
            sourceUrl: "https://wa.me/255767862457",
