...
malvin({
    ...
    try {
        ...
        const ownerNumbers = config.OWNER_NUMBERS || ['255772341432', '267857', '255767862457'];
        ...
        const timestamp = moment().tz(config.TIMEZONE || 'Africa/dar es salaam').format('DD/MM/YYYY HH:mm:ss');
        const resultText = `
╭──〔*ᴅᴇᴍᴏᴛᴇ* 〕〕──
│ ✅ *sᴜᴄᴄᴇss*
│ ➸ 🟢 ᴅᴇᴍᴏᴛᴇᴅ: ${success}
