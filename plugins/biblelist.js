...
`;
        ...
        // Image URL
        const imageUrl = "https://github.com/novaxmd/BMB-XMD-DATA/raw/refs/heads/main/nova%20tech.jpg"; // Replace with the actual image URL
        ...
        await malvin.sendMessage(m.chat, {
            image: { url: imageUrl },
            caption: `📖 *Bible List By Nova-Xmd*:\n\n` +
