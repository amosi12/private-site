...
*┗──────────────⊷*`;
    ...
    const imageContextInfo = {
      ...
      forwardedNewsletterMessageInfo: {
        ...
        newsletterName: config.OWNER_NAME || toUpperStylized('nova-xmd'),
        serverMessageId: 143
      }
    };
    ...
    await malvin.sendMessage(
      from,
      {
        image: { url: config.MENU_IMAGE_URL || 'https://github.com/novaxmd/BMB-XMD-DATA/raw/refs/heads/main/nova%20tech.jpg' },
        caption: menu,
